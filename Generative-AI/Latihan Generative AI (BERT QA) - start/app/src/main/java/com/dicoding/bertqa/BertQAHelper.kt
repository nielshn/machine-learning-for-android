...
class BertQAHelper(val context: Context, private val resultAnswerListener: ResultAnswerListener?) {
    ...
    private fun setupBertQuestionAnswerer() {
        ...
        try {
            ...
            resultAnswerListener?.onError("Bert Question Answerer failed to be initialized")
